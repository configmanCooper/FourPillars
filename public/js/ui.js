...
(function () {
  ...
  const UNIT_HINT = { militia: 'cheap fodder — fills ranks fast', spearman: 'counters 🐎 cavalry', swordsman: 'durable frontline melee', archer: 'ranged — needs 🏹 arrows; +25% on a team outpost, +50%/wall', cavalry: 'fast flanker — counters 🏹 archers & soft units', catapult: 'wrecks 🏰 Keeps & walls (needs Workshop)' };
